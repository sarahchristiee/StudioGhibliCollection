...
export default function Home() {
  ...
  const kikiRef = useRef<HTMLElement>(null);
  const { scrollYProgress: kikiProgress } = useScroll({
    target: kikiRef,
    offset: ["start end", "end start"],
  });

  const kikiY = useTransform(kikiProgress, [0, 1], [-60, 480]);
  const kikiX = useTransform(kikiProgress, [0, 1], [-20, 180]);
  const kikiRotate = useTransform(kikiProgress, [0, 1], [-8, 8]);
      ...
      <main className="min-h-[250vh] w-full m-0">
        ...
        <section className="relative z-20 min-h-screen">
          ...
          <article ref={totoroRef} className="relative w-full font-franklin mt-32 py-12">
            ...
            <div className="relative z-10 mx-auto grid w-full items-center gap-12 lg:grid-cols-2">
              ...
              <div className="relative flex flex-col items-start gap-6 px-12 lg:items-end lg:text-right">
                ...
                <p className="max-w-lg font-franklin text-base font-medium leading-relaxed text-gray-900 sm:text-lg">
          ...
          <article ref={ponyoRef} className="relative w-full font-franklin mt-32 py-12">
            ...
            <div className="relative z-10 mx-auto grid w-full items-center gap-12 lg:grid-cols-2">
              <div className="relative flex flex-col items-start gap-6 px-12 lg:items-end lg:text-right">
                <p className="max-w-md font-franklin text-base font-medium leading-relaxed text-gray-900 sm:text-lg">
          ...
          <article
            ref={kikiRef}
            className="relative w-full max-w-5xl mx-auto mt-24 py-12 px-6 overflow-hidden"
          >
            {/* TÍTULO PRINCIPAL */}
            ...
            {/* KIKI VOANDO (Animação Parallax com Scroll) */}
            <motion.img
              src="/img/kikiHome.svg"
              alt="Kiki voando em sua vassoura"
              className="absolute top-4 left-6 z-20 w-44 md:w-56 pointer-events-none drop-shadow-md"
              style={{
                y: kikiY,
                x: kikiX,
                rotate: kikiRotate,
            ...
            {/* ================= BLOCO 1: HAYAO MIYAZAKI ================= */}
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 mb-20">
              {/* Foto + Legenda (Esquerda) */}
              <div className="flex flex-col items-center shrink-0 w-full md:w-[320px]">
                <img
                  src="/img/Hayao.png"
              ...
              <div className="flex-1">
                <p className="text-gray-900 text-base md:text-lg leading-relaxed font-sans">
                  Hayao Miyazaki foi um dos cofundadores do Studio Ghibli e um mestre da animação japonesa,
                  tendo dirigido os seguintes filmes no estúdio: O Castelo no Céu, Meu Amigo Totoro, O Serviço
                  de Entregas da Kiki, Porco Rosso: O Último Herói, Princesa Mononoke, A Viagem de Chihiro,
                  O Castelo Animado, Ponyo: Uma Amizade que Veio do Mar, Vidas ao Vento e O Menino e a Garça.
                </p>
              </div>
            </div>

            {/* ================= BLOCO 2: ISAO TAKAHATA ================= */}
            <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12">
              {/* Texto (Esquerda) */}
              <div className="flex-1">
                <p className="text-gray-900 text-base md:text-lg leading-relaxed font-sans text-left md:text-right">
                  Isao Takahata foi um dos cofundadores do Studio Ghibli e um mestre da animação japonesa,
                  conhecido por seu realismo profundo e narrativas intimistas, tendo dirigido os seguintes
                  filmes no estúdio: Túmulo dos Vagalumes, Memórias de Ontem, PomPoko: A Grande Batalha dos
                  Guaxinins, Meus Vizinhos os Yamadas e O Conto da Princesa Kaguya.
                </p>
              </div>

              {/* Foto + Legenda (Direita) */}
              <div className="flex flex-col items-center shrink-0 w-full md:w-[320px]">
                <img
                  src="/img/Isao.png"
