...
interface SliderProps {
  images?: string[]; // Recebe um array com os paths das imagens vindas do JSON
}

export default function Slider({ images = [] }: SliderProps) {
  const [currentIndex, setCurrentIndex] = useState(0);

  // Se não houver imagens, não exibe o componente para evitar erros
